...
const Sidebar = ({ ProfileData }) => {
  ...
  return (
    <div className="h-auto  rounded shadow lg:h-[100%] flex flex-col p-3 items-center justify-between">
      ...
      {role !== "admin" && (
        <div className="w-full  flex-col items-center justify-center hidden lg:flex">
          <Link
            to="/profile"
            className=" font-semibold w-full py-2 text-center hover:bg-zinc-200 rounded transition-all duration-300"
          >
            Favourites
          </Link>
          <Link
            to="/profile/orderHistory"
            className=" font-semibold w-full  py-2 mt-4 text-center hover:bg-zinc-200 rounded transition-all duration-300"
          >
            Order History
          </Link>
          <Link
