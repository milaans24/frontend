...
const ViewBookDetails = () => {
  ...
  return (
    <>
      {!Book && <Loader />}
      {Book && (
        <div className=" px-12 py-8 flex flex-col lg:flex-row gap-8 h-auto">
          <div className="w-full lg:w-3/6 ">
            <div className=" flex flex-col md:flex-row items-start justify-around rounded px-4 py-8 gap-4 ">
              <img
                src={Book.url}
                alt="book"
          ...
          <div className="w-full lg:w-3/6 my-8">
            ...
            <p className="bg-zinc-900 px-4 py-2 rounded my-4 text-zinc-100 text-xl font-bold w-fit">
              ₹ {Book.price}
            </p>
